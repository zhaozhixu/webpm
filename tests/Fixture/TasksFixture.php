...
class TasksFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'start' => ['type' => 'datetime', 'length' => null, 'null' => true, 'default' => 'CURRENT_TIMESTAMP', 'comment' => '', 'precision' => null],
        'end' => ['type' => 'datetime', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        'modified' => ['type' => 'datetime', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        'assigner_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'tasks_ibfk_1' => ['type' => 'foreign', 'columns' => ['assigner_id'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'tasks_ibfk_2' => ['type' => 'foreign', 'columns' => ['receiver_id'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'tasks_ibfk_3' => ['type' => 'foreign', 'columns' => ['project_id'], 'references' => ['projects', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'tasks_ibfk_4' => ['type' => 'foreign', 'columns' => ['product_id'], 'references' => ['products', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'tasks_ibfk_5' => ['type' => 'foreign', 'columns' => ['type_id'], 'references' => ['types', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'tasks_ibfk_6' => ['type' => 'foreign', 'columns' => ['priority_id'], 'references' => ['priorities', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'tasks_ibfk_7' => ['type' => 'foreign', 'columns' => ['state_id'], 'references' => ['states', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'priority_id' => 1,
            'state_id' => 1,
            'start' => '2016-11-23 11:43:59',
            'end' => '2016-11-23 11:43:59',
            'modified' => '2016-11-23 11:43:59',
            'assigner_id' => 1,
            'receiver_id' => 1,
            'project_id' => 1,
            'product_id' => 1
