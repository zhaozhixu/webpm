...
<body>
    <nav class="top-bar expanded" data-topbar role="navigation">
        ...
        <div class="top-bar-section">
            <ul class="right">
                <li><a target="_self" href="<?= '/users/view/'.$this->Auth->getUser('id')?>"><?= $this->Auth->getUser('username')?></a></li>
                <li><a target="_self" href="/users/logout">Log Out</a></li>
                <!-- <li><a target="_self" href="http://api.cakephp.org/3.0/">API</a></li> -->
            </ul>
        </div>
        <!-- <div class="top-bar-section">
             <ul class="left">
             <li><a target="_self" href="/projects">Project</a></li>
             <li><a target="_self" href="/products">Product</a></li>
             <li><a target="_self" href="/tasks">Task</a></li>
             <li><a target="_self" href="/notices">Notice</a></li>
             <li><a target="_self" href="/versions">Version</a></li>
             </ul>
             </div> -->
    </nav>
    <?= $this->Flash->render() ?>
